        ...
        try:
            ...
            try:
                ...
                if(firsthash != secondhash):
                    ...
                    name = str('./rezLimitTag/'+str(index)+'_'+name+'.html')
                    ...
                    if(fil1 == fil2):
                        ...
                        if(len(chx) < 20):
                            ...
                            if(len(refrecorDCL) <= 8 and len(refrecorDCL) >= 1):
                                print(index,". page is NOT OK changes num <8: ", url['url'], "|| HASH: ",url['checks'][arr_len-1]['hash'])
                                ...
                                print(index,". page is NOT OK (NO CHECK num +8): ", url['url'], "|| HASH: ",url['checks'][arr_len-1]['hash'])    
                        else:
                            print(index,". page is NOT OK (NO CHECK num +8): ", url['url'], "|| HASH: ",url['checks'][arr_len-1]['hash'])    
                else:
